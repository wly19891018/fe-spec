...
describe('Validate JS configs', () => {
  it('Validate wly-fe-eslint-config', async () => {
  ...
  it('Validate wly-fe-eslint-config/es5', async () => {
  ...
  it('Validate wly-fe-eslint-config/vue', async () => {
  ...
  it('Validate wly-fe-eslint-config/essential', async () => {
  ...
  it('Validate wly-fe-eslint-config/essential/es5', async () => {
  ...
  it('Validate wly-fe-eslint-config/essential/react', async () => {
  ...
  it('Validate wly-fe-eslint-config/essential/vue', async () => {
  ...
  it('Validate wly-fe-eslint-config/node', async () => {
