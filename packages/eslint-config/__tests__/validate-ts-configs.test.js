...
describe('Validate TS configs', () => {
  it('Validate wly-fe-eslint-config/typescript', async () => {
  ...
  it('Validate wly-fe-eslint-config/typescript/vue', async () => {
  ...
  it('Validate wly-fe-eslint-config/essential/typescript', async () => {
  ...
  it('Validate wly-fe-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate wly-fe-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate wly-fe-eslint-config/typescript/node', async () => {
